...
import { ArrowRight, Building2, CalendarDays, Download, FileText, MapPinned, Search, Settings, Target } from "lucide-react";
...
export default function BidsPage() {
  ...
  return <main className="business-screen"><header className="procurement-header no-print"><Link className="procurement-brand" href="/"><span className="procurement-brand-mark">HM</span><span>Market Scout</span></Link><nav className="procurement-nav"><Link href="/"><Target size={16} />仕入分析</Link><Link href="/competition"><Building2 size={16} />競合分析</Link><Link className="active" href="/bids"><Building2 size={16} />入札情報</Link></nav><div className="procurement-header-actions"><Link href="/settings"><Settings size={16} />設定</Link></div></header>
